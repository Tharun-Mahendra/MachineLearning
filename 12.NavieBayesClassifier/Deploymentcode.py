...
if file is not None:
    ...
    scaling_method = st.selectbox("Select Scaling Method", ("StandardScaler", "Normalizer","None"))
    ...
    model = st.selectbox("Choose a model", ("GaussianNB", "MultinomialNB", "BernoulliNB"))
    if model == "GaussianNB":
        model = GaussianNB()
