...
model = pickle.load(open(r'C:\Users\TharunMahendra\NIT\6.Algorithms\1.Regression\1.SimpleLinearRegression\SalaryPrediction\salary_prediction_model.pkl', 'rb'))
